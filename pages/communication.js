...
export default () => {
    return(
        ...
        <div className="flex flex-col justify-center items-center h-screen">
            ...
            <a className="text-2xl p-4 px-5 rounded-lg m-4 font-bold border-solid border-2 text-green-600 border-green-600" href="https://api.whatsapp.com/send?phone=+97317641172">Whatsapp</a>
