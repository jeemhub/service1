...
export default function Homecom() {
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center bg-gray-900">
      ...
      <button className="text-gray-900 px-7 bg-white p-2 mt-6 font-bold rounded-2xl text-2xl">
        <Link href="/firstbtn">
          عاملاتنا المطيعات بالطلب
        </Link>
      </button>
      <button className="text-white  p-2 mt-2 border-solid border-white border-2 rounded-2xl text-2xl">
        <Link href="secbtn">
